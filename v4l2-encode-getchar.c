...
struct buffer *prepare_buffers(int fd, int type)
{
        ...
        printf("prepare_buffers: getchar: about to VIDIOC_REQBUFS\n");
        getchar();
        ...
        for (n_buffers = 0; n_buffers < N_BUFS; ++n_buffers) {
                ...
                printf("prepare_buffers: getchar: about to VIDIOC_QUERYBUF\n");
	        getchar();
        ...
        if (type == V4L2_BUF_TYPE_VIDEO_CAPTURE)
                for (i = 0; i < n_buffers; ++i) {
                        ...
                        buf.memory = V4L2_MEMORY_MMAP;
                        buf.index = i;
                        printf("prepare_buffers: getchar: about to VIDIOC_QBUF\n");
                        getchar();
